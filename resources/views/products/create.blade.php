<x-app-layout>
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                      class="w-full rounded-lg border border-pink-500/50 dark:border-purple-500/50 bg-gray-800 dark:bg-gray-900 text-white focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all duration-300 text-sm px-5 py-3 shadow-sm hover:bg-gray-700">{{ old('description') }}</textarea>
                            @error('description')
                            <p class="mt-2 text-sm text-pink-400 dark:text-purple-400">{{ $message }}</p>
                            @enderror
                        </div>
 ...
 rounded-lg text-sm font-bold text-white border border-pink-500/50 dark:border-purple-500/50 bg-gray-800 dark:bg-gray-900 hover:bg-gray-700 transition-all duration-300 shadow-sm">
                            Cancel
                        </a>
